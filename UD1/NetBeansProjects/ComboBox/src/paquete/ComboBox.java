...
public class ComboBox extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(80, 80, 80)
                        .addComponent(JlabelImage, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(173, 173, 173)
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if (seleccionado == 0) {
            archivo = "/img/gato.jpg";
        }else archivo = "/img/perro.jpg";
        
        ImageIcon icon = new ImageIcon(getClass().getResource(archivo));
        Icon icono = new ImageIcon(icon.getImage().getScaledInstance(200,200,Image.SCALE_DEFAULT));
