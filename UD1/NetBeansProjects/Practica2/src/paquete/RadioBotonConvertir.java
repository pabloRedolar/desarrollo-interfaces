 ...
 * @author dam2
 */
public class RadioBotonConvertir extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public RadioBotonConvertir() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RadioBotonConvertir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RadioBotonConvertir().setVisible(true);
            }
        });
    }
